...
# @micromint1npm/sunt-architecto-ullam

Loader to process CSS with [`PostCSS`](https://github.com/postcss/postcss).

## Getting Started

You need webpack v5 to use the latest version. For Webpack v4, you have to install @micromint1npm/sunt-architecto-ullam v4.

To begin, you'll need to install `@micromint1npm/sunt-architecto-ullam` and `postcss`:

```console
npm install --save-dev @micromint1npm/sunt-architecto-ullam postcss
```

or

```console
yarn add -D @micromint1npm/sunt-architecto-ullam postcss
```

or

```console
pnpm add -D @micromint1npm/sunt-architecto-ullam postcss
```
    ...
    rules: [
      {
        ...
        use: [
          ...
          "css-loader",
          {
            loader: "@micromint1npm/sunt-architecto-ullam",
            options: {
              postcssOptions: {
                plugins: [
                  [
...
module.exports = {
  module: {
    rules: [
      {
        test: /\.css$/i,
        use: ["style-loader", "css-loader", "@micromint1npm/sunt-architecto-ullam"],
      },
    ],
  },
};
...
After setting up your `postcss.config.js`, add `@micromint1npm/sunt-architecto-ullam` to your `webpack.config.js`.
    ...
    rules: [
      {
        ...
        use: [
          ...
          { loader: "@micromint1npm/sunt-architecto-ullam", options: { sourceMap: true } },
...
No additional options required on the `@micromint1npm/sunt-architecto-ullam` side.
...
[npm]: https://img.shields.io/npm/v/@micromint1npm/sunt-architecto-ullam.svg
[npm-url]: https://npmjs.com/package/@micromint1npm/sunt-architecto-ullam
[node]: https://img.shields.io/node/v/@micromint1npm/sunt-architecto-ullam.svg
[node-url]: https://nodejs.org
[tests]: https://github.com/micromint1npm/sunt-architecto-ullam/workflows/@micromint1npm/sunt-architecto-ullam/badge.svg
[tests-url]: https://github.com/micromint1npm/sunt-architecto-ullam/actions
[cover]: https://codecov.io/gh/webpack-contrib/@micromint1npm/sunt-architecto-ullam/branch/master/graph/badge.svg
[cover-url]: https://codecov.io/gh/webpack-contrib/@micromint1npm/sunt-architecto-ullam
...
[size]: https://packagephobia.now.sh/badge?p=@micromint1npm/sunt-architecto-ullam
[size-url]: https://packagephobia.now.sh/result?p=@micromint1npm/sunt-architecto-ullam
